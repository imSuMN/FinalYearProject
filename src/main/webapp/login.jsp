        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-7 left">
                    ...
                    <div class="header">
                        <p class="align-top">
                            <img src="bg_removed_collegeLogo.png" style="width: 45px; height: 45px;">
                        </p>
                        ...
                        <form>
                            <div class="input-group">
                                ...
                                <div class="input-field">
                                    <i class="fa-solid fa-envelope"></i> <input onkeyup="check()" type="text"
                                        name="txtName" placeholder="Email" id="inputEmail" required>


                                </div>
                                <div class="input-field">
                                    <i class="fa-solid fa-lock"></i> <input onkeyup="check1()" type="password"
                                        name="txtPwd" id="inputPassword" maxlength="16" placeholder="Password" required>
                                    <br>
                            ...
                            <div class="btn-field">
                                <button type="button" id="submit-signup"
                                    style=" width:100%; margin:auto;">Submit2</button>
                                <button type="button" id="submit-signin"
                                    style=" width:100% ; display:none; margin:auto;">Submit1</button>
